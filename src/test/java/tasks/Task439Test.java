...
class Task439Test {
    ...
    public class Find {
        @Test
        public void shouldReturnLastEventWhenLastIsAtFirstOfArray() {
        ...
        @Test
        public void shouldReturnLastEventWhenLastIsInMiddleOfArray() {
            entities.Event[] events = new entities.Event[] {
                    new entities.Event(2010, 8, 21, "birthday"),
                    new entities.Event(2009, 12, 20, "jobOffer"),
        ...
        @Test
        public void shouldReturnLastEventWhenLastIsAtLastOfArray() {
            entities.Event[] events = new entities.Event[] {
                    new entities.Event(2010, 8, 21, "birthday"),
        ...
        @Test
        public void shouldReturnLastEventWhenEventsContainOneElement() {
        ...
        @Test
        public void shouldReturnLastEventWhenEventWithoutElement() {
            entities.Event[] events = new entities.Event[] {};
            Event actual = Task439.findLast(events);
        ...
        @Test
        public void shouldReturnLastEventWhenEventHaveTreeSameYears() {
            entities.Event[] events = new entities.Event[] {
                    new entities.Event(2010, 8, 21, "birthday"),
                    new entities.Event(2012, 12, 20, "jobOffer"),
        ...
        @Test
        public void shouldReturnLastEventWhenEventsHaveSameMonthAndHaveDifferenceYearsAndDays() {
            entities.Event[] events = new entities.Event[]{
        ...
        @Test
        public void shouldReturnLastEventWhenEventsHaveSameEventsWithEqualElements() {
            entities.Event[] events = new entities.Event[]{
